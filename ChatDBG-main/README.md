...
> [!IMPORTANT]
>
> ChatDBG currently needs to be connected to a [Google AI Studio account](https://aistudio.google.com/). You can get a free API key that provides access to Gemini models, which ChatDBG uses. [Get a key here.](https://aistudio.google.com/app/apikey)
>
> Once you have an API key, set it as an environment variable called `GEMINI_API_KEY`.
>
> ```bash
